...
import { formatDate, previewContent, sliceContent } from "../../utils/helper";
  ...
  return (
    <div className='group shadow-lg m-2 w-[350px] h-[600px] hover:bg-teal-500 cursor-pointer' onClick={onClick}>
      ...
      <div className='text p-5  group-hover:text-white h-1/2'>
        ...
        <p className="text-gray-600 text-base text-justify group-hover:text-white">{formatDate(blog.created_at)+','+previewContent(blog.content,30)}</p>
      </div>
    </div>
  );
};
