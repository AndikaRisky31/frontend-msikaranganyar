...
const DataPasien = () => {
  ...
  return (
    <section className='awrapper bg-cover bg-center bg-no-repeat h-30vh text-white' style={{ backgroundImage: "url('/images/awrapper.webp')" }}>
      <div className='container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4'>
        <div className='box flex flex-col items-center justify-center p-7'>
          <div className='img'>
