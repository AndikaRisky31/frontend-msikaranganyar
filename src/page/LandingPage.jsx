...
const LandingPage = () => {
    ...
    <>
        <div className="max-sm:pt-[75%] max-lg:pt-[10%]">
            ...
            <Heading subtitle="memberikan kontribusi dalam memperbaiki kesehatan, sosial, dan pendidikan masyarakat melalui berbagai program yang berfokus pada penanggulangan penyakit menular, perubahan sosial budaya, dan peningkatan akses pendidikan." title="VISI DAN MISI" link="/about" />
